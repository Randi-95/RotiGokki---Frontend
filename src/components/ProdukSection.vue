...
<template>
  <div class="w-full flex flex-col items-center px-4 py-10">
    <div class="flex flex-col items-center text-center mb-10">
      ...
      <h1 class="font-fredokaone text-primary text-2xl sm:text-3xl lg:text-4xl">
        Temukan Roti Gokki Pilihanmu
      </h1>
    </div>
    ...
    >
      ...
      >
        ...
        <p
          class="font-poppins text-[10px] sm:text-xs text-center px-2 text-gray-600"
        >
          Lelehan krim cokelat mewah yang lumer tak tertahankan di setiap
          gigitan.
        </p>
        <div class="flex items-center w-full mt-4 px-4 justify-between">
          <p class="font-bold font-poppins text-sm sm:text-base">Rp. 3.500</p>
          <div
